...
describe("Core 01", function () {
	...
	it("getDocumentUri returns only location part of url", function () {
		...
		assert.strictEqual(tv5.getDocumentUri("http://example.com"), "http://example.com");

		assert.strictEqual(tv5.getDocumentUri("http://example.com/main"), "http://example.com/main");
		assert.strictEqual(tv5.getDocumentUri("http://example.com/main/"), "http://example.com/main/");
		//assert.strictEqual(tv5.getDocumentUri("http://example.com/main//"), "http://example.com/main/");

		assert.strictEqual(tv5.getDocumentUri("http://example.com/main/sub"), "http://example.com/main/sub");
		assert.strictEqual(tv5.getDocumentUri("http://example.com/main/sub/"), "http://example.com/main/sub/");
		...
		assert.strictEqual(tv5.getDocumentUri("http://example.com/main?"), "http://example.com/main?");
		assert.strictEqual(tv5.getDocumentUri("http://example.com/main?q=1"), "http://example.com/main?q=1");
		assert.strictEqual(tv5.getDocumentUri("http://example.com/main?q=1#abc"), "http://example.com/main?q=1");

		assert.strictEqual(tv5.getDocumentUri("http://example.com/main/#"), "http://example.com/main/");
		assert.strictEqual(tv5.getDocumentUri("http://example.com/main/#?"), "http://example.com/main/");
		assert.strictEqual(tv5.getDocumentUri("http://example.com/main/#?q=a/b/c"), "http://example.com/main/");
	});
});
...
describe("Strings 01", function () {
	...
	it("check error message", function () {
		...
		var valid = tv5.validate(data, schema);
		assert.isFalse(valid);
		//return typeof tv5.error.message !== "undefined";
		assert.ok(tv5.error.message);
	});
});
...
describe("API 02", function () {
	...
	it("tv5.errorCodes exists", function () {
		assert.isObject(tv5.errorCodes);
		//return typeof tv5.errorCodes == "object";
	});
});
...
describe("Registering custom validator", function () {
	...
	it("Do not track property definitions from unselected \"oneOf\"", function () {
		...
		var result2 = tv5.validateMultiple(data, schema, false);
